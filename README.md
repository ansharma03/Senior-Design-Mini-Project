...
**Before Starting**:
After downloading the project, please run the command **cd ios/ && pod install** inside the Project file on the terminal. This will install all necessary pods and modules of this projects.
